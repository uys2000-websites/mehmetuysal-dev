<template>
  <div class="prose bg-base-100 text-base-content rounded-box p-4 overflow-auto h-full flex-shrink">
    ...
    <ul>
      ...
      <li>
        <p><strong>Application</strong> refers to UPlayer, the software program provided by the Company.</p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
          data-cfemail="39515079545c51545c4d4c404a5855175d5c4f">[email&nbsp;protected]</a></li>
    </ul>
  </div>
</template>